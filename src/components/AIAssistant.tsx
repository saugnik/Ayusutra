...
const AIAssistant: React.FC = () => {
    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 font-sans">
            {/* Chat Window */}
            {isOpen && (
                <div className="bg-white rounded-2xl shadow-2xl w-96 h-[32rem] flex flex-col mb-4 overflow-hidden border border-gray-200 animate-fade-in-up">
                    {/* Header */}
                                ...
                                >
                                    {msg.sender === 'ai' && (
                                        <div className="flex items-center space-x-1 mb-1 opacity-75">
                                            ...
                                            <span className="text-xs font-semibold text-primary-600">AyurGenius</span>
                                        </div>
                                    )}
                    ...
                    <div className="p-4 bg-white border-t border-gray-100">
                        <div className="flex items-center space-x-2 bg-gray-50 rounded-full border border-gray-200 px-4 py-2 focus-within:ring-2 focus-within:ring-primary-500 focus-within:border-transparent transition-all">
                            <input
                                type="text"
                                value={inputValue}
                                ...
                                className="flex-1 bg-transparent border-none focus:ring-0 text-sm py-1 placeholder-gray-400 text-gray-700"
                                disabled={isLoading}
                            />
                            <button
                                onClick={handleSend}
